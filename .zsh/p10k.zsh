[[ $ZSH_THEME =~ powerlevel* ]] || return

# Type `p10k configure` to generate config.
...
() {
  ...
  # Filler between left and right prompt on the first prompt line ( , · or ─).
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR='─'
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_BACKGROUND=
  # The color of the filler. Match the color of POWERLEVEL9K_MULTILINE
  # ornaments defined above.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=$POWERLEVEL9K_BACKGROUND
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=$POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL=$POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR
  ...
  # Custom icon. As same as default but needed to set it to remove padding at
  # the right side.
  ...
  # === kubecontext: current kubernetes context ============================{{{1
