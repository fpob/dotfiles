let g:c_functions = 0
let g:c_ansi_functions = 1
let g:c_ansi_names = 1
...
syn keyword cConstant C_ISREG C_ISBLK C_ISCHR C_ISCTG C_ISLNK C_ISSOCK
" }}}
" fcntln.h {{{
syn keyword cConstant F_DUPFD F_GETFD F_SETFD F_GETFL F_SETFL F_GETLK F_SETLK
syn keyword cConstant F_SETLKW F_RDLCK F_UNLCK F_WRLCK O_CREAT O_EXCL O_NOCTTY
syn keyword cConstant O_TRUNC O_APPEND O_DSYNC O_NONBLOCK O_RSYNC O_SYNC
syn keyword cConstant O_ACCMODE O_RDONLY O_RDWR O_WRONLY
" }}}
" netinet/in.h {{{
syn keyword cType in_port_t in_addr_t
syn keyword cConstant IPPROTO_IP IPPROTO_ICMP IPPROTO_TCP IPPROTO_UDP
syn keyword cConstant INADDR_ANY INADDR_BROADCAST
" }}}
" sys/socket.h {{{
syn keyword cType socklen_t sa_family_t
syn keyword cConstant SOCK_DGRAM SOCK_STREAM SOCK_SEQPACKET SOL_SOCKET
syn keyword cConstant SO_ACCEPTCONN SO_BROADCAST SO_DEBUG SO_DONTROUTE
syn keyword cConstant SO_ERROR SO_KEEPALIVE SO_LINGER SO_OOBINLINE SO_RCVBUF
syn keyword cConstant SO_RCVLOWAT SO_RCVTIMEO SO_REUSEADDR SO_SNDBUF
syn keyword cConstant SO_SNDLOWAT SO_SNDTIMEO SO_TYPE
syn keyword cConstant MSG_CTRUNC MSG_DONTROUTE MSG_EOR MSG_OOB MSG_PEEK
syn keyword cConstant MSG_TRUNC MSG_WAITALL
syn keyword cConstant AF_UNIX AF_UNSPEC AF_INET AF_INET6 SHUT_RD SHUT_WR
syn keyword cConstant SHUT_RDWR PF_INET
" }}}
" sys/types.h {{{
syn keyword cType blkcnt_t blksize_t clock_t clockid_t dev_t
syn keyword cType fsblkcnt_t fsfilcnt_t
syn keyword cType gid_t id_t ino_t key_t mode_t nlink_t off_t pid_t
syn keyword cType pthread_attr_t pthread_cond_t pthread_condattr_t pthread_key_t
syn keyword cType pthread_mutex_t pthread_mutexattr_t pthread_once_t
syn keyword cType pthread_rwlock_t pthread_rwlockattr_t pthread_t
syn keyword cType size_t ssize_t suseconds_t time_t timer_t uid_t useconds_t
" }}}
" sys/time.h {{{
syn keyword cType time_t suseconds_t
" }}}
" sys/stat.h {{{
syn keyword cConstant S_IFMT S_IFBLK S_IFCHR S_IFIFO S_IFREG S_IFDIR S_IFLNK
syn keyword cConstant S_IRWXU S_IRUSR S_IWUSR S_IXUSR S_IRWXG S_IRGRP S_IWGRP
syn keyword cConstant S_IXGRP S_IRWXO S_IROTH S_IWOTH S_IXOTH S_ISUID S_ISGID
syn keyword cConstant S_ISVTX
" }}}
" sys/ipc.h {{{
syn keyword cConstant IPC_CREAT IPC_EXCL IPC_NOWAIT IPC_PRIVATE IPC_RMID
syn keyword cConstant IPC_SET IPC_STAT
" }}}
" semaphore.h {{{
syn keyword cType sem_t
" }}}
" assert.h {{{
